...
var inputStyle = (0, _styledComponents.css)(["box-sizing:border-box;", " font-family:inherit;border:none;-webkit-appearance:none;background:transparent;color:inherit;box-shadow:inset 1px 1px 1px 0 ", ";", " ", " ", " margin:0;", "::-webkit-search-decoration{-webkit-appearance:none;}"], function (props) {
