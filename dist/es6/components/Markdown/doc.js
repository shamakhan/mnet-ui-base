...
export var doc = function doc(Markdown) {
  var DocumentedMarkdown = describe(Markdown).availableAt(getAvailableAtBadge('Markdown')).description('Markdown formatting using MnetUIBase components.').usage("import { Markdown } from 'mnet-ui-base';\n      <Markdown>{content}</Markdown>").intrinsicElement('div');
