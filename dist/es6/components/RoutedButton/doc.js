...
export var doc = function doc(RoutedButton) {
  var DocumentedRoutedButton = describe(RoutedButton).availableAt(getAvailableAtBadge('RoutedButton')).description('A button with support for React Router.').usage("import { RoutedButton } from 'mnet-ui-base';\n<RoutedButton primary path='/documentation' />").intrinsicElement('button');
