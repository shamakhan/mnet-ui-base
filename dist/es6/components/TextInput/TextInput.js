...
import { StyledTextInput, StyledTextInputContainer, StyledPlaceholder, StyledIcon, StyledSuggestions, StyledHelperTextWrapper } from './StyledTextInput';
...
var TextInput = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var a11yTitle = _ref.a11yTitle,
      ...
      rest = _objectWithoutPropertiesLoose(_ref, ["a11yTitle", "defaultValue", "dropAlign", "dropHeight", "dropTarget", "dropProps", "icon", "id", "messages", "name", "onBlur", "onChange", "onFocus", "onKeyDown", "onSelect", "onSuggestionsClose", "onSuggestionsOpen", "placeholder", "error", "readOnly", "plain", "reverse", "suggestions", "value", "errorMessage"]);
  ...
  var suggestionRefs = {};
  var ErrorIcon = theme.textInput.error.icon; // if this is a readOnly property, don't set a name with the form context
  ...
  return /*#__PURE__*/React.createElement(StyledHelperTextWrapper, null, /*#__PURE__*/React.createElement(StyledTextInputContainer, {
    plain: plain
  ...
  }))), drop), error && /*#__PURE__*/React.createElement(Text, _extends({}, theme.textInput.error.text, {
    color: "brand"
  }), errorMessage));
});
