...
export var doc = function doc(RoutedAnchor) {
  var DocumentedRoutedAnchor = describe(RoutedAnchor).availableAt(getAvailableAtBadge('RoutedAnchor')).description('An Anchor with support for React Router.').usage("import { RoutedAnchor } from 'mnet-ui-base';\n" + "<RoutedAnchor primary path='/documentation' />").intrinsicElement('a');
