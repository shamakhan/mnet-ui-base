...
export var doc = function doc(Sidebar) {
  var DocumentedSidebar = describe(Sidebar).availableAt(getAvailableAtBadge('Sidebar')).description('A sidebar, typically used with Nav children.').usage("import { Sidebar } from 'mnet-ui-base';\n<Sidebar/>").intrinsicElement('div');
