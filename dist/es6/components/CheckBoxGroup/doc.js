...
export var doc = function doc(CheckBoxGroup) {
  var DocumentedCheckBoxGroup = describe(CheckBoxGroup).availableAt(getAvailableAtBadge('CheckBoxGroup')).description('A group of CheckBoxes.').usage("import { CheckBoxGroup } from 'mnet-ui-base';\n        <CheckBoxGroup />").intrinsicElement('div');
