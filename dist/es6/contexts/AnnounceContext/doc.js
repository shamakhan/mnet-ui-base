...
export var doc = function doc(AnnounceContext) {
  var DocumentedAnnounceContext = describe(AnnounceContext).availableAt(getAvailableAtBadge('AnnounceContext')).description('A means of announcing events for screen readers.').usage("import { AnnounceContext } from 'mnet-ui-base';\n" + '<AnnounceContext.Consumer />\n{announce => ()}');
