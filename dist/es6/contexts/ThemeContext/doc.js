...
export var doc = function doc(ThemeContext) {
  var DocumentedThemeContext = describe(ThemeContext).availableAt(getAvailableAtBadge('ThemeContext')).description('A means of tweaking the theme for contained components.').usage("import { ThemeContext } from 'mnet-ui-base';\n" + '<ThemeContext.Extend value={value} />');
