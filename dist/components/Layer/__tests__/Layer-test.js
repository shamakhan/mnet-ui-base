...
var SimpleLayer = function SimpleLayer() {
  ...
  if (showLayer) {
    layer = /*#__PURE__*/_react["default"].createElement(_.Layer, {
      "data-testid": "test-dom-removal"
    }, "This is a test");
  }

  return /*#__PURE__*/_react["default"].createElement(_.Box, null, layer);
};
...
var FakeLayer = function FakeLayer(_ref) {
  ...
  if (showLayer) {
    ...
    }, "This is a layer", /*#__PURE__*/_react["default"].createElement("input", {
      "data-testid": "test-input"
    })));
  }

  return /*#__PURE__*/_react["default"].createElement(_.Box, null, layer, children);
};
...
var TargetLayer = function TargetLayer(props) {
  ...
  if (target) {
    layer = /*#__PURE__*/_react["default"].createElement(_.Layer, _extends({}, props, {
      target: target
    }), "this is a test layer");
  }

  return /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement("div", {
    ref: setTarget
  }), layer);
};
...
describe('Layer', function () {
  ...
  ['top', 'bottom', 'left', 'right', 'start', 'end', 'center'].forEach(function (position) {
    return test("position " + position, function () {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(_.Layer, {
        id: "position-test",
        position: position
      }, "This is a layer")));
  ...
  test('hidden', function () {
    var _render = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(_.Layer, {
      id: "hidden-test",
      position: "hidden"
    }, "This is a layer"))),
    ...
    rerender( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(_.Layer, {
      id: "hidden-test",
      position: "center"
    }, "This is a layer")));
    (0, _portal.expectPortal)('hidden-test').toMatchSnapshot();
  ...
  test('dark context', function () {
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(_.Box, {
      background: "dark-1"
    }, /*#__PURE__*/_react["default"].createElement(_.Layer, {
      id: "non-modal-test",
      modal: false
    }, "This is a non-modal layer"))));
    (0, _portal.expectPortal)('non-modal-test').toMatchSnapshot();
  ...
  test('invokes onEsc', function () {
    var onEsc = jest.fn();
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(_LayerContainer.LayerContainer, {
      onEsc: onEsc
  ...
  test('is accessible', function (done) {
    ...
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(FakeLayer, {
  ...
  test('target', function () {
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(TargetLayer, {
      id: "target-test"
  ...
  test('unmounts from dom', function () {
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, null, /*#__PURE__*/_react["default"].createElement(SimpleLayer, null)));
    setTimeout(function () {
  ...
  test('custom containerTarget', function () {
    ...
    try {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_.MnetUIBase, {
