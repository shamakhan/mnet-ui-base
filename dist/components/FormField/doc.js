...
var doc = function doc(FormField) {
  ...
  DocumentedFormField.propTypes = {
    ...
    width: _reactDesc.PropTypes.string.description("The width of the field."),
