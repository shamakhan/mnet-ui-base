...
var doc = function doc(CheckBoxGroup) {
  var DocumentedCheckBoxGroup = (0, _reactDesc.describe)(CheckBoxGroup).availableAt((0, _utils.getAvailableAtBadge)('CheckBoxGroup')).description('A group of CheckBoxes.').usage("import { CheckBoxGroup } from 'mnet-ui-base';\n        <CheckBoxGroup />").intrinsicElement('div');
