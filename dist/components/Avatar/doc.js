...
var doc = function doc(Avatar) {
  var DocumentedAvatar = (0, _reactDesc.describe)(Avatar).availableAt((0, _utils.getAvailableAtBadge)('Avatar')).description('An Avatar.').usage("import { Avatar } from 'mnet-ui-base';\n<Avatar/>").intrinsicElement('div');
