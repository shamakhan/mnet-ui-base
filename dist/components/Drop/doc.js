...
var doc = function doc(Drop) {
  var DocumentedDrop = (0, _reactDesc.describe)(Drop).availableAt((0, _utils.getAvailableAtBadge)('Drop')).description('A container that is overlaid next to a target.').usage("import { Drop } from 'mnet-ui-base';\n      \n<Drop target={reference}>...</Drop>").intrinsicElement('div');
