...
var doc = function doc(List) {
  var DocumentedList = (0, _reactDesc.describe)(List).availableAt((0, _utils.getAvailableAtBadge)('List')).description('An ordered list of items.').usage("import { List } from 'mnet-ui-base';\n<List data={[...]} />").intrinsicElement('ol');
