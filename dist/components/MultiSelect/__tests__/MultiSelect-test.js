...
describe('MultiSelect', function () {
  ...
  it('basic', function () {
    ...
    var component = _reactTestRenderer["default"].create( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect"
    }, props)));
  ...
  it('Single Column - Passing value externally - Value Label', function () {
    ...
    var _render = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 3],
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Coulmn - Passing value externally - Option Chips', function () {
    ...
    var _render2 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      withOptionChips: true
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop'));

    var chipsElements = (0, _testUtils.findAll)(document.body, _StyledMultiSelect.OptionLabel); // Match no. of options which are selected
  ...
  it('Single Column - Passing value externally - Verify checkbox check', function () {
    ...
    var _render3 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Column - No values selected - Value Label', function () {
    ...
    var _render4 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Column - No values selected - Option Chips', function () {
    ...
    var _render5 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Column - No values selected - Verify checkbox check', function () {
    ...
    var _render6 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Column - Search - Value match', function () {
    ...
    var _render7 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true,
    ...
    _react2.fireEvent.change(searchElement, {
      target: {
        value: 'Test 1'
      }
    });
  ...
  it('Single Column - Search - Option match', function () {
    ...
    var _render8 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Single Column - Select Option - Verify', function () {
    ...
    var _render9 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop')); // Select Option with id 2


    _react2.fireEvent.click(getByRole('menuitem', {
      name: 'option id - 2'
    }));
  ...
  it('Single Column - Deselect Option - Verify', function () {
    ...
    var _render10 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true
  ...
  it('Single Column - Select All Option - Verify', function () {
    ...
    var _render11 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      withOptionChips: true,
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop')); // Select all option checkbox
  ...
  it('Single Column - Deselect All Option - Verify', function () {
    ...
    var _render12 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
  ...
  it('Single Column - Clear All Option - Verify', function () {
    ...
    var _render13 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Single Column - OK Button', function () {
    ...
    var _render14 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Single Column - Cancel Button', function () {
    ...
    var _render15 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Single Column - Remove Chip - Without update and cancel buttons', function () {
    ...
    var _render16 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop')); // Remove Option Test 2
  ...
  it('Single Column - Remove Chip - With update button', function () {
    ...
    var _render17 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Single Column - Remove Chip - With cancel button', function () {
    ...
    var _render18 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      withOptionChips: true,
  ...
  it('Double Column - Passing value externally - Value Label - Included', function () {
    ...
    var _render19 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 3],
      isExcluded: false,
      onValueChange: setValues,
  ...
  it('Double Column - Passing value externally - Value Label - Excluded', function () {
    ...
    var _render20 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 3],
      isExcluded: true,
      onValueChange: setValues,
  ...
  it('Double Coulmn - Passing inc value externally - Option Chips', function () {
    ...
    var _render21 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      isExcluded: false,
    ...
    var chipsElements = (0, _testUtils.findAll)(document.body, _StyledMultiSelect.OptionLabel);
  ...
  it('Double Coulmn - Passing exc value externally - Option Chips', function () {
    ...
    var _render22 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      isExcluded: true,
  ...
  it('Double Column - Passing inc value externally - Verify checkbox check', function () {
    ...
    var _render23 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      isExcluded: false,
  ...
  it('Double Column - Passing exc value externally - Verify checkbox check', function () {
    ...
    var _render24 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      isExcluded: true,
  ...
  it('Double Column - Passing no value externally - Verify checkbox check', function () {
    ...
    var _render25 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: value,
      onValueChange: setValues,
      isExcluded: null,
    ...
    _react2.fireEvent.mouseOver(getByRole('menuitem', {
      name: 'option id - 2'
    }));
  ...
  it('Double Column - No values selected - Value Label', function () {
    ...
    var _render26 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
  ...
  it('Double Column - No values selected - Option Chips', function () {
    ...
    var _render27 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
  ...
  it('Double Column - Search - Option match', function () {
    ...
    var _render28 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
  ...
  it('Double Column - Select Option (include) - Verify', function () {
    ...
    var _render29 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop')); // Hover option with id 2
    ...
    _react2.fireEvent.click(getByRole('checkbox', {
  ...
  it('Double Column - Select Option (exclude) - Verify', function () {
    ...
    var _render30 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
  ...
  it('Double Column - Clear All - Verify', function () {
    ...
    var _render31 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [1, 2, 3],
      onValueChange: setValues,
      isExcluded: false,
  ...
  it('Double Column - Select All Option - Verify', function () {
    ...
    var _render32 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: [],
      onValueChange: setValues,
      isExcluded: null,
    ...
    _react2.fireEvent.click(getByLabelText('Open Drop')); // Hover option Select All
  ...
  it('Double Column - Deselect All Option - Verify', function () {
    ...
    var _render33 = (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_2.MultiSelect, _extends({
      id: "test-multiselect",
      value: options.map(function (_) {
        return _.id;
      }),
