...
var doc = function doc(Sidebar) {
  var DocumentedSidebar = (0, _reactDesc.describe)(Sidebar).availableAt((0, _utils.getAvailableAtBadge)('Sidebar')).description('A sidebar, typically used with Nav children.').usage("import { Sidebar } from 'mnet-ui-base';\n<Sidebar/>").intrinsicElement('div');
