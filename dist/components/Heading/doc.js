...
var doc = function doc(Heading) {
  var DocumentedHeading = (0, _reactDesc.describe)(Heading).availableAt((0, _utils.getAvailableAtBadge)('Heading')).description('Heading text structured in levels.').usage("import { Heading } from 'mnet-ui-base';\n<Heading />").intrinsicElement(['h1', 'h2', 'h3', 'h4']);
