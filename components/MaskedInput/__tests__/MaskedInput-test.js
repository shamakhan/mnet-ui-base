...
describe('MaskedInput', function () {
  ...
  test('Escape events should propagage if there is no drop', function (done) {
    ...
    var _render5 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_Keyboard.Keyboard, {
      onEsc: callback
  ...
  test('applies custom global.hover theme to options', function (done) {
    ...
    var _render9 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, {
      theme: customTheme
    }, _react["default"].createElement(_.MaskedInput, {
