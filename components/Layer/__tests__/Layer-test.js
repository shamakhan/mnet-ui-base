...
describe('Layer', function () {
  ...
  test('hidden', function () {
    var _render = (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Layer, {
      id: "hidden-test",
      position: "hidden"
    }, "This is a layer"))),
    ...
    rerender(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Layer, {
      id: "hidden-test",
      position: "center"
    }, "This is a layer")));
    (0, _portal.expectPortal)('hidden-test').toMatchSnapshot();
  ...
  test('dark context', function () {
    (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Box, {
      background: "dark-1"
  ...
  test('invokes onEsc', function () {
    var onEsc = jest.fn();
    (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_LayerContainer.LayerContainer, {
      onEsc: onEsc
  ...
  test('is accessible', function (done) {
    ...
    (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(FakeLayer, {
  ...
  test('custom containerTarget', function () {
    ...
    try {
      (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, {
