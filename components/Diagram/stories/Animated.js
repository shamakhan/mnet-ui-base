...
var DiamondContainer = function DiamondContainer(_ref2) {
  ...
  return _react["default"].createElement(_mnetUiBase.Box, {
    ...
    size: "medium",
    weight: "bold"
  }, name), carat && _react["default"].createElement(_mnetUiBase.Text, {
    size: textSize
  }, " Carat: ", carat, " "), color && _react["default"].createElement(_mnetUiBase.Text, {
    size: textSize
  }, " Color: ", color, " "), cut && _react["default"].createElement(_mnetUiBase.Text, {
    size: textSize
  }, " Cut: ", cut, " ")));
};
