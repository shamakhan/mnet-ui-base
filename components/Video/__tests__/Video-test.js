...
test('Video renders', function () {
  var component = _reactTestRenderer["default"].create(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Video, null, CONTENTS)));

  var tree = component.toJSON();
  expect(tree).toMatchSnapshot();
});
test('Video autoPlay renders', function () {
  var component = _reactTestRenderer["default"].create(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Video, {
    autoPlay: true
  }, CONTENTS)));
