...
describe('TextInput', function () {
  ...
  test('suggestions', function (done) {
    ...
    var _render6 = (0, _react2.render)(_react["default"].createElement(_.TextInput, {
  ...
  test('complex suggestions', function (done) {
    var _render7 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: [{
  ...
  test('close suggestion drop', function (done) {
    var _render8 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', 'test1']
  ...
  test('let escape events propagage if there are no suggestions', function (done) {
    ...
    var _render9 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_Keyboard.Keyboard, {
      onEsc: callback
  ...
  test('calls onSuggestionsOpen', function (done) {
    ...
    var _render10 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', 'test1'],
  ...
  test('calls onSuggestionsClose', function (done) {
    ...
    var _render11 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', 'test1'],
  ...
  test('select suggestion', function (done) {
    ...
    var _render12 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      plain: true,
      size: "large",
      id: "item",
  ...
  test('select a suggestion', function () {
    ...
    var _render13 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      suggestions: ['test', {
  ...
  test('handles next and previous without suggestion', function () {
    ...
    var _render14 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      "data-testid": "test-input",
      id: "item",
      name: "item",
      onSelect: onSelect
  ...
  ['small', 'medium', 'large'].forEach(function (dropHeight) {
    test(dropHeight + " drop height", function (done) {
      var _render15 = (0, _react2.render)(_react["default"].createElement(_.TextInput, {
        "data-testid": "test-input",
        id: "item",
        name: "item",
        suggestions: ['test', 'test1'],
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            onSelect = jest.fn();
            _render16 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            onSelect = jest.fn();
            _render17 = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.TextInput, {
              "data-testid": "test-input-focus",
              id: "input-focus",
              name: "input-focus",
              placeholder: "Type to search...",
