...
describe('Button', function () {
  ...
  test('fill', function () {
    var component = _reactTestRenderer["default"].create(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Button, null, _react["default"].createElement(_.Button, {
      fill: true
    }), _react["default"].createElement(_.Button, {
      fill: false
    }), _react["default"].createElement(_.Button, {
  ...
  test('focus', function () {
    var _render = (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Button, {
      label: "Test",
      onClick: function onClick() {}
    }))),
