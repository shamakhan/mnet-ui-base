...
var doc = function doc(Markdown) {
  var DocumentedMarkdown = (0, _reactDesc.describe)(Markdown).availableAt((0, _utils.getAvailableAtBadge)('Markdown')).description('Markdown formatting using MnetUIBase components.').usage("import { Markdown } from 'mnet-ui-base';\n      <Markdown>{content}</Markdown>").intrinsicElement('div');
