    ...
    radioButton: {
      extend: function extend(_ref) {
        var checked = _ref.checked,
            ...
            theme = _ref.theme;
        return _extends({
          backgroundColor: (0, _utils.normalizeColor)(getColor('background', checked, disabled, theme), theme),
          color: (0, _utils.normalizeColor)(getColor('text', checked, disabled, theme), theme),
          '&>div': {
            display: 'none'
          }
        }, theme["switch"]);
