...
describe('Clock', function () {
  ...
  test('time', function () {
    var component = _reactTestRenderer["default"].create(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.Clock, {
      run: false,
      type: "digital",
      time: DURATION
  ...
  test('run', function (done) {
    var _render = (0, _react2.render)(_react["default"].createElement(_MnetUIBase.MnetUIBase, null, _react["default"].createElement(_.Clock, {
      type: "analog",
      run: "forward",
      time: DURATION
    }), _react["default"].createElement(_.Clock, {
