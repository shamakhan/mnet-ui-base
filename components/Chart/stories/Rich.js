...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement(_mnetUiBase.MnetUIBase, {
      ...
      }, _react["default"].createElement(_mnetUiBase.Text, null, y)), _react["default"].createElement(_mnetUiBase.Box, {
        border: "top",
        flex: true
      }));
    })), _react["default"].createElement(_mnetUiBase.Chart, _extends({}, chartProps, {
      type: "area",
      color: {
        color: 'accent-1',
        opacity: 'medium'
