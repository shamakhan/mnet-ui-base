...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return _react["default"].createElement(_mnetUiBase.MnetUIBase, {
    ...
    }, _react["default"].createElement(_mnetUiBase.Text, null, innerAxis[1][0]))), _react["default"].createElement(_mnetUiBase.Box, {
      border: {
        side: 'bottom',
        color: 'accent-2',
        size: 'medium'
    ...
    }, _react["default"].createElement(_mnetUiBase.Text, null, innerAxis[1][1])))), hover && _react["default"].createElement(_mnetUiBase.Box, {
      fill: true,
      align: "center",
      justify: "center"
    }, _react["default"].createElement(_mnetUiBase.Box, {
      ...
      size: "large",
      weight: "bold"
    }, hover.value[1]), _react["default"].createElement(_mnetUiBase.Text, null, new Date(hover.value[0]).toLocaleDateString())))), _react["default"].createElement(_mnetUiBase.Stack, null, _react["default"].createElement(_mnetUiBase.Chart, {
      type: "line",
      bounds: outerBounds,
      values: outerValues,
      size: {
