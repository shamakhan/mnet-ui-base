...
describe('Calendar', function () {
  ...
  test('date', function () {
    ...
    var component = _reactTestRenderer["default"].create(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Calendar, {
      date: DATE,
      animate: false
    })));
  ...
  test('select date', function () {
    ...
    var _render = (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Calendar, {
      date: DATE,
      onSelect: onSelect,
      animate: false
    }))),
  ...
  test('select dates', function () {
    ...
    var _render2 = (0, _react2.render)(_react["default"].createElement(_.MnetUIBase, null, _react["default"].createElement(_.Calendar, {
      dates: DATES,
      onSelect: onSelect,
      animate: false
    }))),
