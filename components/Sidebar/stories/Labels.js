...
var SidebarHeader = function SidebarHeader() {
  return _react["default"].createElement(_mnetUiBase.Box, {
    ...
    round: true,
    responsive: false
  })), _react["default"].createElement(_mnetUiBase.Text, null, "Shimrit Yacobi"));
};
...
var SidebarFooter = function SidebarFooter() {
  return _react["default"].createElement(_mnetUiBase.Nav, null, _react["default"].createElement(SidebarButton, {
