...
describe('Clock', function () {
  afterEach(cleanup);
  test('time', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Clock, {
      run: false,
      type: "digital",
      time: DURATION
  ...
  test('run', function (done) {
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(Clock, {
      type: "analog",
      run: "forward",
      time: DURATION
    }), React.createElement(Clock, {
