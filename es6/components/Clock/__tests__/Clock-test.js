...
describe('Clock', function () {
  afterEach(cleanup);
  test('time', function () {
    var component = renderer.create( /*#__PURE__*/React.createElement(MnetUIBase, null, /*#__PURE__*/React.createElement(Clock, {
      run: false,
      type: "digital",
      time: DURATION
  ...
  test('run', function (done) {
    var _render = render( /*#__PURE__*/React.createElement(MnetUIBase, null, /*#__PURE__*/React.createElement(Clock, {
      type: "analog",
      run: "forward",
      time: DURATION
    }), /*#__PURE__*/React.createElement(Clock, {
