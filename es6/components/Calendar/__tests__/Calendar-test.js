...
describe('Calendar', function () {
  ...
  test('date', function () {
    ...
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Calendar, {
      date: DATE,
      animate: false
    })));
  ...
  test('select date', function () {
    ...
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(Calendar, {
      date: DATE,
      onSelect: onSelect,
      animate: false
    }))),
  ...
  test('select dates', function () {
    ...
    var _render2 = render(React.createElement(MnetUIBase, null, React.createElement(Calendar, {
      dates: DATES,
      onSelect: onSelect,
      animate: false
    }))),
