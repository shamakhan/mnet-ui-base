...
describe('Layer', function () {
  ...
  test('hidden', function () {
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(Layer, {
      id: "hidden-test",
      position: "hidden"
    }, "This is a layer"))),
    ...
    rerender(React.createElement(MnetUIBase, null, React.createElement(Layer, {
      id: "hidden-test",
      position: "center"
    }, "This is a layer")));
    expectPortal('hidden-test').toMatchSnapshot();
  ...
  test('dark context', function () {
    render(React.createElement(MnetUIBase, null, React.createElement(Box, {
      background: "dark-1"
  ...
  test('invokes onEsc', function () {
    var onEsc = jest.fn();
    render(React.createElement(MnetUIBase, null, React.createElement(LayerContainer, {
      onEsc: onEsc
  ...
  test('is accessible', function (done) {
    ...
    render(React.createElement(MnetUIBase, null, React.createElement(FakeLayer, {
