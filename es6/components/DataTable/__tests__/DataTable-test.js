...
describe('DataTable', function () {
  afterEach(cleanup);
  test('empty', function () {
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(DataTable, null))),
        container = _render.container;

    expect(container.firstChild).toMatchSnapshot();
  });
  test('basic', function () {
    var _render2 = render(React.createElement(MnetUIBase, null, React.createElement(DataTable, {
      columns: [{
        property: 'a',
        header: 'A'
      }, {
