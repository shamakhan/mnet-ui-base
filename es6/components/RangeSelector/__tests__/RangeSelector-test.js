...
describe('RangeSelector', function () {
  afterEach(cleanup);
  test('basic', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(RangeSelector, {
      values: [20, 30]
    })));
  ...
  test('opacity', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, ['weak', 'medium', 'strong'].map(function (opacity) {
  ...
  test('round', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, ['xsmall', 'small', 'medium', 'large', 'full'].map(function (round) {
      return React.createElement(RangeSelector, {
        key: round,
        round: round,
        values: [20, 30]
  ...
  test('size', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, ['xxsmall', 'xsmall', 'small', 'medium', 'large', 'xlarge', 'full'].map(function (size) {
      return React.createElement(RangeSelector, {
        key: size,
        size: size,
        values: [20, 30]
  ...
  test('step renders correct values', function () {
    ...
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(RangeSelector, {
      values: [0, 100],
      step: 3,
      onChange: onChange
    }))),
  ...
  test('handle keyboard', function () {
    ...
    var _render2 = render(React.createElement(MnetUIBase, null, React.createElement(RangeSelector, {
      values: [20, 30],
      onChange: onChange
    }))),
  ...
  test('handle mouse', function () {
    ...
    var _render3 = render(React.createElement(MnetUIBase, null, React.createElement(RangeSelector, {
      values: [20, 30],
      onChange: onChange
    }))),
