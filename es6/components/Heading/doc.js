...
export var doc = function doc(Heading) {
  var DocumentedHeading = describe(Heading).availableAt(getAvailableAtBadge('Heading')).description('Heading text structured in levels.').usage("import { Heading } from 'mnet-ui-base';\n<Heading />").intrinsicElement(['h1', 'h2', 'h3', 'h4']);
