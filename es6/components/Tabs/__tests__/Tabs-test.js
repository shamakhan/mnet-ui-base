...
describe('Tabs', function () {
  test('no Tab', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Tabs, null, React.createElement(Tab, null))));
    expect(component.toJSON()).toMatchSnapshot();
  });
  test('Tab', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Tabs, null, React.createElement(Tab, {
      title: "Tab 1"
  ...
  test('change to second tab', function () {
    ...
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(Tabs, {
      onActive: onActive
  ...
  test('set on hover', function () {
    var _render2 = render(React.createElement(MnetUIBase, null, React.createElement(Tabs, null, React.createElement(Tab, {
      title: "Tab 1",
