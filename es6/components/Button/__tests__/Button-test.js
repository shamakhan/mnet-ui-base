...
describe('Button', function () {
  ...
  test('fill', function () {
    var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Button, null, React.createElement(Button, {
      fill: true
    }), React.createElement(Button, {
      fill: false
    }), React.createElement(Button, {
  ...
  test('focus', function () {
    var _render = render(React.createElement(MnetUIBase, null, React.createElement(Button, {
      label: "Test",
      onClick: function onClick() {}
    }))),
