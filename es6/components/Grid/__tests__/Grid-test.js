...
test('Grid renders', function () {
  var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Grid, null)));
  var tree = component.toJSON();
  expect(tree).toMatchSnapshot();
});
test('a11yTitle renders', function () {
  var _render = render(React.createElement(MnetUIBase, null, React.createElement(Grid, {
    a11yTitle: "My Grid"
  }))),
...
test('Grid rows renders', function () {
  var component = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Grid, {
...
test('Grid proxies tag', function () {
  var tagComponent = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Grid, {
    tag: "article"
  })));
  var asComponent = renderer.create(React.createElement(MnetUIBase, null, React.createElement(Grid, {
    as: "article"
  })));
